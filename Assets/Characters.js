...
const data = parse("./Assets/csv_logic/characters.csv")
const skills = parse("./Assets/csv_logic/skills.csv")
const projectiles = parse("./Assets/csv_logic/projectiles.csv")
let skindata = parse("./Assets/csv_logic/skins.csv")
let confdata = parse("./Assets/csv_logic/skin_confs.csv")
