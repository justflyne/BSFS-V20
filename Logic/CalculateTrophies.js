...
function calculateGemGrab(trophies, win2lose) {
    const trophyRanges = [
        { "min": 0, "max": 49, "rewards": [8, 0] },
        { "min": 50, "max": 99, "rewards": [8, -1] },
        { "min": 100, "max": 199, "rewards": [8, -2] },
        { "min": 200, "max": 299, "rewards": [8, -3] },
        { "min": 300, "max": 399, "rewards": [8, -4] },
        { "min": 400, "max": 499, "rewards": [8, -5] },
        { "min": 500, "max": 599, "rewards": [8, -6] },
        { "min": 600, "max": 699, "rewards": [8, -7] },
        { "min": 700, "max": 799, "rewards": [8, -8] },
        { "min": 800, "max": 899, "rewards": [7, -9] },
        { "min": 900, "max": 999, "rewards": [6, -10] },
        { "min": 1000, "max": 1099, "rewards": [4, -10] },
        { "min": 1100, "max": 1199, "rewards": [3, -10] },
        { "min": 1200, "max": Infinity, "rewards": [3, -10] }
    ];
    const currentRange = trophyRanges.find(range => trophies >= range.min && trophies <= range.max);
